...
export default function PhimHoatHinhPage() {
    ...
    <div className="p-6 pt-40">
      <FilterBar
            ...
            onApplyFilters={(appliedFilters) => {
                ...
                const currentCategory = window.location.pathname.includes("hoat-hinh")
                ? "phim-le"
      ...
      <MovieList filters={filters} title="Phim hoạt hình" />
    </div>
  );
}
